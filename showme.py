...
def main():
    ...
    parser.add_argument('--type', type=str, choices=['ec2','sub','vpce','rds','vpn','cvpn','sg','peer','all'], help='Type of report when service is vpc - sub (subnets)')
    ...
    keys_to_show = select_keys_to_show(service=args.service, region=args.region,report_type=args.type, output=args.output)
